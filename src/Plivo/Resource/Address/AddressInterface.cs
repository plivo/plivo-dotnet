...
namespace Plivo.Resource.Address
{
    ...
    public class AddressInterface : ResourceInterface
    {
        ...
        )
        {
            ...
            return Client.Update<AddressCreateResponse>(Uri, data, filesToUpload).Object;
        }
        ...
        )
        {
            ...
            return Client.Update<UpdateResponse<Address>>(Uri + addressId + "/", data, filesToUpload).Object;
        }
        ...
        {
            var address = GetResource<Address>(id);
            ...
            uint? offset = null)
        {
            ...
            var resources = ListResources<ListResponse<Address>>(data);
        ...
        {
            return DeleteResource<DeleteResponse<Address>>(id);
        }
    }
}