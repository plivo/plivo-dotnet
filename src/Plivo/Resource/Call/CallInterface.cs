...
namespace Plivo.Resource.Call
{
    ...
    public class CallInterface : ResourceInterface
    {
        ...
        /// endTime_Lte, parentCallUuid, plivoHangupSource, plivoHangupCauseCode, limit and offset.
        /// </summary>
        ...
        /// <param name="parentCallUuid">Parent call UUID.</param>
        /// <param name="plivoHangupSource">Plivo Hangup Source.</param>
        /// <param name="plivoHangupCauseCode">Plivo Hangup Cause Code.</param>
        ...
        public ListResponse<Call> List(
            ...
            string plivoHangupSource = null, uint? plivoHangupCauseCode = null,
