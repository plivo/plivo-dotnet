...
namespace Plivo.Resource.Conference
{
    ...
    public class ConferenceInterface : ResourceInterface
    {
        ...
        public async Task<AsyncResponse> GetAsync(string conferenceName, string callbackUrl = null, string callbackMethod = null)
        {
            ...
            var result = Task.Run (async () => await Client.Fetch<AsyncResponse> (Uri + conferenceName + "/", data).ConfigureAwait(false)).Result;
            await Task.WhenAll();
        ...
        public async Task<AsyncResponse> DeleteAllAsync(string callbackUrl = null, string callbackMethod = null)
        {
            ...
            var result = Task.Run (async () => await Client.Delete<AsyncResponse> (Uri, data).ConfigureAwait(false)).Result;
            await Task.WhenAll();
            result.Object.StatusCode = result.StatusCode;
            return result.Object;
        }
        ...
        public async Task<AsyncResponse> DeleteAsync(string name, string callbackUrl = null, string callbackMethod = null)
        {
            ...
            var result = Task.Run (async () => await Client.Delete<AsyncResponse> (Uri + name + "/", data).ConfigureAwait(false)).Result;
            await Task.WhenAll();
            result.Object.StatusCode = result.StatusCode;
            return result.Object;
        }
            ...
            string conferenceName, string memberId, string callbackUrl = null, string callbackMethod = null)
        {
            ...
            var result = Task.Run (async () => await Client.Delete<AsyncResponse> (Uri + conferenceName + "/Member/" + memberId + "/", data).ConfigureAwait(false)).Result;
            await Task.WhenAll();
            result.Object.StatusCode = result.StatusCode;
            return result.Object;
        }
            ...
            string conferenceName, string memberId, string callbackUrl = null, string callbackMethod = null)
        {
            ...
            var result = Task.Run (async () => await Client.Update<AsyncResponse> (Uri + conferenceName + "/Member/" + memberId + "/Kick/", data).ConfigureAwait(false)).Result;
            await Task.WhenAll();
            result.Object.StatusCode = result.StatusCode;
            JObject responseJson = JObject.Parse(result.Content);
            result.Object.ApiId = responseJson["api_id"].ToString();
            ...
            string conferenceName, List<string> memberId, string callbackUrl = null, string callbackMethod = null)
        {
            ...
            var result = Task.Run (async () => await Client.Update<AsyncResponse> (Uri + conferenceName + "/Member/" + string.Join(",", memberId) + "/Mute/", data).ConfigureAwait(false)).Result;
            await Task.WhenAll();
            result.Object.StatusCode = result.StatusCode;
            JObject responseJson = JObject.Parse(result.Content);
            result.Object.ApiId = responseJson["api_id"].ToString();
            ...
            string conferenceName, List<string> memberId, string callbackUrl = null, string callbackMethod = null)
        {
            ...
            var result = Task.Run (async () => await Client.Delete<AsyncResponse> (Uri + conferenceName + "/Member/" + string.Join(",", memberId) + "/Mute/", data).ConfigureAwait(false)).Result;
            await Task.WhenAll();
            result.Object.StatusCode = result.StatusCode;
            return result.Object;
        }
            ...
            string conferenceName, List<string> memberId, string url, string callbackUrl = null, string callbackMethod = null)
        {
            ...
            var result = Task.Run (async () => await Client.Update<AsyncResponse> (Uri +
                ...
                "/Member/" +
                string.Join(",", memberId) +
                "/Play/", data).ConfigureAwait(false)).Result;
            await Task.WhenAll();
            result.Object.StatusCode = result.StatusCode;
            JObject responseJson = JObject.Parse(result.Content);
            result.Object.ApiId = responseJson["api_id"].ToString();
            ...
            string callbackUrl = null, string callbackMethod = null)
        {
            ...
            var result = Task.Run(async () => await Client.Delete<AsyncResponse>(
                    ...
                    "/Member/" +
                    string.Join(",", memberId) +
                    "/Speak/", data).ConfigureAwait(false))
                .Result;
            await Task.WhenAll();
            result.Object.StatusCode = result.StatusCode;
            return result.Object;
            ...
            string callbackUrl = null, string callbackMethod = null)
        {
            ...
            var result = Task.Run(async () => await Client.Update<AsyncResponse>(
                ...
                string.Join(",", memberId) +
                "/Deaf/",
                data).ConfigureAwait(false)).Result;
            await Task.WhenAll();
            result.Object.StatusCode = result.StatusCode;
            JObject responseJson = JObject.Parse(result.Content);
            result.Object.ApiId = responseJson["api_id"].ToString();
         ...
         string callbackUrl = null, string callbackMethod = null)
        {
            ...
            var result = Task.Run(async () => await Client.Delete<AsyncResponse>(
                ...
                "/Member/" +
                string.Join(",", memberId) +
                "/Deaf/", data).ConfigureAwait(false)).Result;
            await Task.WhenAll();
            result.Object.StatusCode = result.StatusCode;
            return result.Object;
        }
         ...
         string callbackMethod = null)
        {
            ...
            var result = Task.Run(async () => await Client.Delete<AsyncResponse>(
                Uri + conferenceName + "/Record/", data).ConfigureAwait(false)).Result;
            await Task.WhenAll();
            result.Object.StatusCode = result.StatusCode;
            return result.Object;
        }
