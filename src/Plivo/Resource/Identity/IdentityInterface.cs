...
namespace Plivo.Resource.Identity
{
    ...
    public class IdentityInterface : ResourceInterface
    {
        ...
        {
            var identity = GetResource<Identity>(id);
            ...
            uint? offset = null)
        {
            ...
            var resources = ListResources<ListResponse<Identity>>(data);
        ...
        {
            return DeleteResource<DeleteResponse<Identity>>(id);
        }
        ...
        )
        {
            ...
            return Client.Update<IdentityCreateResponse>(Uri, data, filesToUpload).Object;
        }
        ...
        )
        {
            ...
            return Client.Update<UpdateResponse<Identity>>(Uri + identityId + "/", data, filesToUpload).Object;
        }
    }
}