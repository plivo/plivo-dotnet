...
namespace Plivo.Resource.Brand
{
    ...
    public class BrandInterface : ResourceInterface
    {
        ...
        public BrandCreateResponse Create(string brand_alias, string profile_uuid, string type, bool secondary_vetting)
        {
       ...
       /// <returns>The create.</returns>
        ...
        /// <param name="brand_type">brand_type.</param>
        /// <param name="secondary_vetting">secondary_vetting.</param>
		public async Task<BrandCreateResponse> CreateAsync(string brand_alias, string profile_uuid, string type, bool secondary_vetting)
		{
