        ...
        public void TestCampaignCreate()
        {
            ...
            Assert.Empty(
                ComparisonUtilities.Compare(
                    response,
                    Api.Campaign.Create(campaign_alias: "camapign_test_name",brand_id:"BYEKDY1",vertical:"REAL_ESTATE", usecase:"MIXED",description:"description should be minimum 40 character",  embedded_link:false,embedded_phone:false,  age_gated:false,
