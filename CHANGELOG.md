# Change Log
## [5.53.0](https://github.com/plivo/plivo-dotnet/tree/v5.53.0) (2026-08-19)
**Feature - Caller Reputation profile-first API**
- Added optional `enable_caller_reputation`, `caller_reputation_carriers`, `url` and `method` parameters to `Profile.Update` and `Profile.UpdateAsync`, serialized to the matching wire keys
...
## [5.51.6](https://github.com/plivo/plivo-dotnet/tree/v5.51.6) (2026-02-18)
...
## [5.51.5](https://github.com/plivo/plivo-dotnet/tree/v5.51.5) (2026-01-22)
**Feature - HA Number support**
- Added `haEnabled` optional parameter to phone number Buy methods for enabling HA functionality during phone number rent
- Added `fallbackNumber` optional field to phone number buy response, and list/get number response
