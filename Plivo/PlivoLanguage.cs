...
namespace Plivo.Language
{
    public class Language
    {
        ...
        public const string English_Australian = "en-Au";
        public const string English_Canadian = "en-CA";
        public const string English_British = "en-GB";
        public const string English_USA = "en-US";
        public const string Spanish = "es-ES";
        public const string Spanish_USA = "es-US";
